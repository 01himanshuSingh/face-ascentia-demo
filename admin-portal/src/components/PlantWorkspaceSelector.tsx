...
export function PlantWorkspaceSelector({
  ...
  return (
    <label className="flex min-w-[11rem] flex-col gap-1 text-[0.7rem] font-semibold uppercase tracking-[0.08em] text-text-muted">
      Plant workspace
      <select
        className="h-10 rounded-xl border border-border/80 bg-surface px-3 text-sm font-medium text-text outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 disabled:bg-background"
